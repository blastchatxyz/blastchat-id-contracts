...
contract BlastSniperzIdMetadata is OwnableWithManagers {
  string public description = "The official web3 name and digital identity of the BlastSniperz NFT community.";
  string public brand = "BlastSniperz.io";
